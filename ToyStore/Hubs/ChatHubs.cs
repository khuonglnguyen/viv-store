...
namespace SourceCode.Hubs
{
    public class ChatHubs : Hub
    {
        public ChatHubs()
        {
            var tableDependency = new SqlTableDependency<Message>(ConfigurationManager.ConnectionStrings["ShopPhuKienEntitiesConnectionString"].ConnectionString, tableName: "Message", schemaName: "dbo", executeUserPermissionCheck: false, includeOldValues: true);
